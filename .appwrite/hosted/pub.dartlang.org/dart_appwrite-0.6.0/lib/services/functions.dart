...
class Functions extends Service {
  ...
  /// endpoint.
  ///
  Future<Response> updateTag(
      {required String functionId, required String tag}) {
  ...
  ///
  Future<Response> deleteTag(
      {required String functionId, required String tagId}) {
    final String path = '/functions/{functionId}/tags/{tagId}'
        .replaceAll(RegExp('{functionId}'), functionId)
        .replaceAll(RegExp('{tagId}'), tagId);
